                ...
                <div className="px-6 mt-6 space-y-6">
                    ...
                    <div className="bg-white shadow rounded-lg p-6">
                        ...
                        <div className="mt-4 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                            <Link href="/dashboard/records_officer/docket?status=Active&status=Urgent&status=Due" className="block">
                            ...
                            <Link href="/dashboard/records_officer/docket?status=Overdue" className="block">
                            ...
                            <Link href="/dashboard/records_officer/docket?status=For%20Review" className="block">
                            ...
                            <Link href="/dashboard/records_officer/docket?status=Completed" className="block">
                    ...
                    <div className="bg-white shadow rounded-lg p-6 mt-6">
                        <div className="flex flex-col lg:flex-row justify-between">
                            ...
                            <UrgentCases
                                ...
                                basePath="/dashboard/records_officer/docket"
                            />
